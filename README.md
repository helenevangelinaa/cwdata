...
[![R build
status](https://github.com/helenevangelinaa/cwdata/workflows/R-CMD-check/badge.svg)](https://github.com/helenevangelinaa/cwdata/actions)
<!-- badges: end -->
...
devtools::install_github("helenevangelinaa/cwdata")
```
